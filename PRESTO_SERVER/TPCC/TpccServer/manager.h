...
//macro
#define TMMANAGER_NEWORDER(managerPtr,W_ID,D_ID,C_ID)						manager_newordertransaction(TM_ARG managerPtr,W_ID,D_ID,C_ID)
#define TMMANAGER_PAYMENT(managerPtr,W_ID,D_ID,C_ID,H_AMOUNT,c_flag) 	manager_paymenttransaction(TM_ARG managerPtr,W_ID,D_ID,C_ID,H_AMOUNT,c_last)
#define TMMANAGER_ORDSTATUS(managerPtr,W_ID,D_ID,C_ID)						manager_orderstatustransaction(TM_ARG managerPtr, W_ID,  D_ID,  C_ID)
#define TMMANAGER_STOCKLEVEL(managerPtr,W_ID,D_ID,treshold)					manager_stockleveltransaction(TM_ARG managerPtr, W_ID,  D_ID,  treshold)
#define TMMANAGER_DELIVERY(managerPtr,W_ID,O_CARRIER_ID)					manager_deliverytransaction(TM_ARG managerPtr, W_ID, O_CARRIER_ID);
